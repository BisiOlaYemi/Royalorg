  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 gap-x-0 px-4 md:px-24 mt-16'>
      ...
      <div className="md:pr-8">
        ...
        <p className="text-center md:text-left font-[Open Sans] font-medium">Royal Heritage International Enterprise  is a leading provider of logistics, haulage, telecom services, and event management solutions - we specialize in delivering top-notch services to our clients, helping them streamline their operations and achieve their business goals. With our extensive industry experience and a dedicated team of professionals, we pride ourselves on delivering exceptional results and exceeding customer expectations. Whether you need efficient transportation solutions, reliable telecom services, or expert event management, Royal is your trusted partner for all your business needs.</p>
        <div className='mt-12'>
        <Link to="">

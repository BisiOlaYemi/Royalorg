    ...
    <div className="py-16 mt-12">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-gray-600 text-center mb-12">
           We support industry and trade in the global exchange of merchandise through land, air, and ocean transport.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white rounded-lg shadow-md p-6 hover:bg-gray-50 transform hover:scale-105 transition-all">
            <div className="flex flex-col items-center justify-center h-full">
              <h3 className="text-xl font-semibold mb-4">Logistics </h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:bg-gray-50 transform hover:scale-105 transition-all">
            <div className="flex flex-col items-center justify-center h-full">
              <h3 className="text-xl font-semibold mb-4">Haulage </h3>
              <ul className="text-gray-600 list-disc pl-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:bg-gray-50 transform hover:scale-105 transition-all">
            <div className="flex flex-col items-center justify-center h-full">
              <h3 className="text-xl font-semibold mb-4">Telecom</h3>
              <ul className="text-gray-600 list-disc pl-4">
